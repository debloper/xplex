...
3. <details>
   <summary>Manage Firewall Rules</summary>

   <Xplex /> uses port `80` for HTTP & port `1935` for RTMP. Please make sure the [firewall on the host system is configured](/refs/manage/firewall) to allow traffic on these ports.
