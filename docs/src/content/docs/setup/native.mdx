...
This is **not the recommended way to deploy xplex**, but if you're feeling adventurous and want to build and deploy it manually, then here's how to do it.
...
🎉 Congrats... You should now have <Xplex /> up and running on your host system!
