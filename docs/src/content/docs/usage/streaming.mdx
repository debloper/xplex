...
3. **Run a Test Stream**
   ...
   You will have to update <Xplex isHQ="true" /> with this URL before starting test stream. Make sure to reset the URL with `?bandwidthtest=true` parameter removed before going live.
   :::
</Steps>
